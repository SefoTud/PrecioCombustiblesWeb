...
import { getFirestore, doc, setDoc, getDoc, deleteDoc, onSnapshot } from "https://www.gstatic.com/firebasejs/12.14.0/firebase-firestore.js";
  ...
  const D = document, q = i => D.getElementById(i);
            ...
            let map = L.map("map", { zoomControl: false, maxZoom: 19, closePopupOnClick: false }).setView([40.41, -3.70], 6);
            ...
            <div class="card-hist-gas">
                ...
                <div class="flex-row-center" style="gap:8px;">
                    ...
                    <div class="btn-group-sm">
                        ...
                        <button class="btn-icon-only btn-icon-delete" onclick="borrarBitacora(${b.id})" title="Borrar">🗑️</button>
                    </div>
                </div>
            </div>`;
            ...
            <div class="card-hist-taller">
                ...
                <div class="flex-row-center" style="gap:8px;">
                    ...
                    <div class="btn-group-sm">
                        ...
                        <button class="btn-icon-only btn-icon-delete" onclick="borrarTaller(${m.id}, true)" title="Borrar">🗑️</button>
                    </div>
                </div>
            </div>`;
        }
